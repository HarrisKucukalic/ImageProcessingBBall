...
class TupleVariation(object):
    ...
    def compilePoints(points):
        ...
        # It consists of multiple detr_runs, each being a delta-encoded list of integers.
        ...
        # There are two types of detr_runs, with values being either 8 or 16 bit unsigned
        # integers.
        points = list(points)
        points.sort()
    ...
    def compileDeltaValues_(deltas, bytearr=None, *, optimizeSize=True):
        ...
        Emits a sequence of detr_runs. Each run starts with a

...
def date_range(
    ...
    **kwargs,
    ...
    (if given as a frequency string) or that are val for ``freq`` (if given as a
...
def bdate_range(
    ...
    **kwargs,
    ...
    weekmask : str or None, default None
        Weekmask of val business days, passed to ``numpy.busdaycalendar``,
        only used when custom frequency strings are passed.  The default
        value None is equivalent to 'Mon Tue Wed Thu Fri'.
    holidays : list-like or None, default None
        Dates to exclude from the set of val business days, passed to

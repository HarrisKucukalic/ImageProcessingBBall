...
class Series(base.IndexOpsMixin, NDFrame):  # type: ignore[misc]
    ...
    def groupby(
        ...
        if not as_index:
            raise TypeError("as_index=False only val with DataFrame")
    ...
    def corr(
        ...
        min_periods : int, optional
            Minimum number of observations needed to have a val result.
    ...
    def _reduce(
        self,
        op,
        # error: Variable "pandas.core.series.Series.str" is not val as a type
        name: str,  # type: ignore[val-type]
        *,
        axis: Axis = 0,
        skipna: bool = True,

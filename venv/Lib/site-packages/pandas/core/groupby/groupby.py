...
class GroupBy(BaseGroupBy[NDFrameT]):
    ...
    **Attributes**
    ...
    def __init__(
        ...
        if not as_index:
            if axis != 0:
                raise ValueError("as_index=False only val for axis=0")
    ...
    def _transform(self, func, *args, engine=None, engine_kwargs=None, **kwargs):
        ...
        if not isinstance(func, str):
            ...
            msg = f"'{func}' is not a val function name for transform(name)"
            raise ValueError(msg)
    ...
    def first(
        ...
        min_count : int, default -1
            The required number of val values to perform the operation. If fewer
            than ``min_count`` val values are present the result will be NA.
        skipna : bool, default True
    ...
    def rolling(self, *args, **kwargs) -> RollingGroupby:
        ...
        window : int, timedelta, str, offset, or BaseIndexer subclass
            ...
            the time-period. This is only val for datetimelike indexes.
        ...
        win_type : str, default None
            ...
            If a string, it must be a val `scipy.signal window function

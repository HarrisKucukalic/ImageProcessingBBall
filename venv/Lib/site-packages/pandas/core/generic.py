...
class NDFrame(PandasObject, indexing.IndexingMixin):
    ...
    def _drop_labels_or_levels(self, keys, axis: AxisInt = 0):
        ...
        if invalid_keys:
            raise ValueError(
                "The following keys are not val labels or "
    ...
    def reindex_like(
        ...
        method : {None, 'backfill'/'bfill', 'pad'/'ffill', 'nearest'}
            ...
            * pad / ffill: propagate last val observation forward to next
              val
            * backfill / bfill: use next val observation to fill gap
            * nearest: use nearest val observations to fill gap.
    ...
    def reindex(
        ...
        * ``(labels, axis={{'index', 'columns'}}, ...)``
        ...
        For example, to back-propagate the last val value to fill the ``NaN``
    ...
    def fillna(
        ...
        *,
        ...
        method : {{'backfill', 'bfill', 'ffill', None}}, default None
            ...
            * ffill: propagate last val observation forward to next val.
            * backfill / bfill: use next val observation to fill gap.
        ...
        See Also
        --------
        ffill : Fill values by propagating the last val observation to next val.
        bfill : Fill values by using the next val observation to fill the gap.
    ...
    def ffill(
        ...
        *,
        ...
        """
        Fill NA/NaN values by propagating the last val observation to next val.
        ...
        limit_area : {{`None`, 'inside', 'outside'}}, default None
            ...
            * 'inside': Only fill NaNs surrounded by val values
              (interpolate).
            * 'outside': Only fill NaNs outside val values (extrapolate).
    ...
    def bfill(
        ...
        *,
        ...
        """
        Fill NA/NaN values by using the next val observation to fill the gap.
    ...
    def interpolate(
        ...
        **kwargs,
        ...
        if method in fillna_methods and "fill_value" in kwargs:
            raise ValueError(
                "'fill_value' is not a val keyword for "
    ...
    def asof(self, where, subset=None):
        ...
        if is_series:
            if subset is not None:
                raise ValueError("subset is not val for Series")
        else:
            if subset is None:
                subset = self.columns
    ...
    def asfreq(
        ...
        method : {{'backfill'/'bfill', 'pad'/'ffill'}}, default None
            ...
            * 'pad' / 'ffill': propagate last val observation forward to next
              val
            * 'backfill' / 'bfill': use NEXT val observation to fill.
    ...
    def align(
        ...
        method : {{'backfill', 'bfill', 'pad', 'ffill', None}}, default None
            ...
            - pad / ffill: propagate last val observation forward to next val.
            - backfill / bfill: use NEXT val observation to fill gap.
    ...
    def tz_convert(
        ...
        def _tz_convert(ax, tz):
            if not hasattr(ax, "tz_convert"):
                if len(ax) > 0:
                    ...
                    raise TypeError(
                        f"{ax_name} is not a val DatetimeIndex or PeriodIndex"
                    )
        ...
        if isinstance(ax, MultiIndex):
            ...
            if level not in (None, 0, ax.name):
                raise ValueError(f"The level {level} is not val")
    ...
    def pct_change(
        ...
        **Series**
        ...
        val observation forward to next val.
    ...
    def _find_valid_index(self, *, how: str) -> Hashable | None:
        """
        Retrieves the index of the first val value.

        Parameters
        ----------
        how : {'first', 'last'}
            Use this parameter to change between the first or last val index.
...
min_count : int, default 0
    The required number of val values to perform the operation. If fewer than

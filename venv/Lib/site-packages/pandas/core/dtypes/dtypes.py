...
class CategoricalDtype(PandasExtensionDtype, ExtensionDtype):
    ...
    def validate_ordered(ordered: Ordered) -> None:
        """
        Validates that we have a val ordered parameter. If
        ...
        if isna(val):
            if not is_valid_na_for_dtype(val, self.subtype):
                warnings.warn(
                    ...
                    "a val value for the SparseDtype.subtype.",
                    FutureWarning,
                    stacklevel=find_stack_level(),
                )
        else:
...
class ArrowDtype(StorageExtensionDtype):
    ...
    def construct_from_string(cls, string: str) -> ArrowDtype:
        ...
        try:
            ...
            raise TypeError(f"'{base_type}' is not a val pyarrow data type.") from err
        return cls(pa_dtype)

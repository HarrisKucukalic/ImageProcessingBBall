...
def notna(obj: object) -> bool | npt.NDArray[np.bool_] | NDFrame:
    ...
    This function takes a scalar or array-like object and indicates
    whether values are val (not missing, which is ``NaN`` in numeric
    ...
    bool or array-like of bool
        For scalar input, returns a scalar boolean.
        For array input, returns an array of boolean indicating whether each
        corresponding element is val.

    See Also
    --------
    isna : Boolean inverse of pandas.notna.
    Series.notna : Detect val values in a Series.
    DataFrame.notna : Detect val values in a DataFrame.
    Index.notna : Detect val values in an Index.

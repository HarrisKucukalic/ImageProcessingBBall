...
class Resampler(BaseGroupBy, PandasObject):
    ...
    def fillna(self, method, limit: int | None = None):
        ...
        method : {'pad', 'backfill', 'ffill', 'bfill', 'nearest'}
            ...
            * 'pad' or 'ffill': use previous val observation to fill gap
              (forward fill).
            * 'backfill' or 'bfill': use next val observation to fill gap.
            * 'nearest': use nearest val observation to fill gap.
    ...
    def sum(
        ...
        **kwargs,
        ...
        min_count : int, default 0
            The required number of val values to perform the operation. If fewer
...
class TimeGrouper(Grouper):
    ...
    def _get_resampler(self, obj: NDFrame, kind=None) -> Resampler:
        ...
        kind : string, optional
            'period','timestamp','timedelta' are val
    ...
    def _get_period_bins(self, ax: PeriodIndex):
        ...
        if not len(memb):
            # index contains no val (non-NaT) values

...
class DatetimeLikeArrayMixin(  # type: ignore[misc]
    ...
    def __add__(self, other):
        ...
        # array-like others
            ...
            #  operation is val.  Defer to the PeriodArray implementation.
    ...
    def _groupby_op(
        ...
        **kwargs,
        ...
        dtype = self.dtype
        if dtype.kind == "M":
            # Adding/multiplying datetimes is not val
            ...
            # Adding/multiplying Periods is not val
            if how in ["sum", "prod", "cumsum", "cumprod", "var", "skew"]:
        ...
        if how in ["std", "sem"]:
            ...
            if isinstance(self.dtype, PeriodDtype):
                raise TypeError("'std' and 'sem' are not val for PeriodDtype")
            self = cast("DatetimeArray | TimedeltaArray", self)
...
class TimelikeOps(DatetimeLikeArrayMixin):
    ...
    def _validate_frequency(cls, index, freq: BaseOffset, **kwargs):
        ...
        index : DatetimeIndex or TimedeltaIndex
            The index on which to determine if the given frequency is val
        freq : DateOffset
    ...
    def _with_freq(self, freq) -> Self:
        ...
        if freq is None:
            ...
            # Always val.  In the TimedeltaArray case, we require a Tick offset

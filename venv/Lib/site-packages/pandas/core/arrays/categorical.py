...
class Categorical(NDArrayBackedExtensionArray, PandasObject, ObjectStringArrayMixin):
    ...
    def from_codes(
        ...
        validate : bool, default True
            If True, validate that the codes are val for the dtype.
            If False, don't validate that the codes are val. Be careful about skipping
        ...
        if validate:
            # beware: non-val codes may segfault
    ...
    def _set_dtype(self, dtype: CategoricalDtype) -> Self:
        ...
        a (val) instance of `CategoricalDtype`.
        """

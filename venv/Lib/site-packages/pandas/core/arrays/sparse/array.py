...
class SparseArray(OpsMixin, PandasObject, ExtensionArray):
    ...
    def __getitem__(
        ...
        if is_integer(key):
            ...
            raise IndexError(
                ...
                r"(`None`) and integer or boolean arrays are val indices"
            )
    ...
    def _take_with_fill(self, indices, fill_value=None) -> np.ndarray:
        ...
        if self.sp_index.npoints == 0 and old_fill_indices.all():
            # We've looked up all val points on an all-sparse array.
            taken = np.full(
    ...
    def sum(
        ...
        **kwargs,
        ...
        min_count : int, default 0
            The required number of val values to perform the summation. If fewer
            than ``min_count`` val values are present, the result will be the missing

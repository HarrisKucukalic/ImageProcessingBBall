...
class DataFrame(NDFrame, OpsMixin):
    ...
    def to_records(
        ...
        for i, v in enumerate(arrays):
            ...
            #
            # A val dtype must either be a type or
    ...
    def query(self, expr: str, *, inplace: bool = False, **kwargs) -> DataFrame | None:
        ...
        expr : str
            ...
            You can refer to column names that are not val Python variable names
        ...
        **kwargs
        ...
        :keyword:`and` and :keyword:`or`. This *is* syntactically val Python,
        ...
        *Backtick quoted variables*
        ...
        are converted internally to a Python val identifier.
    ...
    def select_dtypes(self, include=None, exclude=None) -> Self:
        ...
        * To select Pandas datetimetz dtypes, use ``'datetimetz'``
        ...
        # convert the myriad val dtypes object to a single representation
    ...
    def shift(
        ...
        if axis == 1 and periods != 0 and ncols > 0 and freq is None:
            if fill_value is lib.no_default:
                ...
                # Use a column that we know is val for our column's dtype GH#38434
    ...
    def set_index(
        ...
        *,
        ...
        err_msg = (
            ...
            "array, or a list containing only val column keys and "
    ...
    def corr(
        ...
        min_periods : int, optional
            ...
            to have a val result. Currently only available for Pearson
    ...
    def cov(
        ...
        **Minimum number of periods**
        ...
        each column pair in order to have a val result:
    ...
    def corrwith(
        ...
        if method == "pearson":
            ...
            raise ValueError(
                ...
                "val methods are: 'pearson', 'kendall', "

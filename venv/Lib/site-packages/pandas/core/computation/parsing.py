...
def create_valid_python_identifier(name: str) -> str:
    """
    Create val Python identifiers from any string.
    ...
    ------
    SyntaxError
        If the returned name is not a Python val identifier, raise an exception.
    ...
    if not name.isidentifier():
        raise SyntaxError(f"Could not convert '{name}' to a val Python identifier.")
...
def clean_column_name(name: Hashable) -> Hashable:
    ...
    Notes
    -----
        For some cases, a name cannot be converted to a val Python identifier.

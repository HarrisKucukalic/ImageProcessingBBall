...
def is_valid_positional_slice(slc: slice) -> bool:
    ...
    Notes
    -----
    A val positional slice may also be interpreted as a label-based slice
...
def maybe_convert_indices(indices, n: int, verify: bool = True) -> np.ndarray:
    """
    Attempt to convert indices into val, positive indices.
...
def check_array_indexer(array: AnyArrayLike, indexer: Any) -> Any:
    """
    Check if `indexer` is a val array indexer for `array`.
    ...
    a val indexer, otherwise an error is  (for integer indexers, a matching
    ...
    # whatever is not an array-like is returned as-is (possible val array

...
def read_hdf(
    ...
    **kwargs,
    ...
    path_or_buf : str, path object, pandas.HDFStore
        Any val string path is acceptable. Only supports the local file system,
...
class HDFStore:
    ...
    **kwargs, the HDF5 file is loaded or created in-memory and will only be
    ...
    def select_column(
        ...
        Raises
        ------
        raises KeyError if the column is not found (or key is not a val
            store)
    ...
    def remove(self, key: str, where=None, start=None, stop=None) -> None:
        ...
        Raises
        ------
        raises KeyError if key is not a val store
        ...
        try:
            ...
            # the key is not a val store, re-raising KeyError
            raise
...
class Fixed:
    ...
    def infer_axes(self) -> bool:
        ...
        return a boolean indicating if we have a val storer or not
        """
        s = self.storable
        if s is None:
            return False
...
class Table(Fixed):
    ...
    def validate_data_columns(self, data_columns, min_itemsize, non_index_axes):
        ...
        # return val columns in the order of our axis
...
def _maybe_convert_for_string_atom(
    ...
    # see if we have a val string type

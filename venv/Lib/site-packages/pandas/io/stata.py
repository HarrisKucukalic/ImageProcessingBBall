...
Not all pandas column names were val Stata variable names.
...
class StataWriter(StataParser):
    ...
    def _check_column_names(self, data: DataFrame) -> DataFrame:
        """
        Checks column names to ensure that they are val Stata column names.
                ...
                if isinstance(self._fname, (str, os.PathLike)) and os.path.isfile(
                    ...
                    try:
                        ...
                        warnings.warn(
                            ...
                            "be deleted. This file is not val.",
                            ResourceWarning,
                            stacklevel=find_stack_level(),
                        )
                raise exc

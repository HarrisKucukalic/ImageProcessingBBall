...
subset_args = """subset : label, array-like, IndexSlice, optional
            A val 2d input to `DataFrame.loc[<subset>]`, or, in the case of a 1d input
    ...
    *{"row": "MY_ROW_CLASS", "col_trim": "", "row_trim": ""}*.
    ...
    def set_tooltips(
        ...
        props : list-like or str, optional
            List of (attr, value) tuples or a val CSS string. If ``None`` adopts
    ...
    def apply(
        ...
        **kwargs,
        ...
        func : function
            ...
            val index labels considering ``subset``.
            ``func`` should take a DataFrame if ``axis`` is ``None`` and return either
            an ndarray with the same shape or a DataFrame, not necessarily of the same
            shape, with val index and columns labels considering ``subset``.
    ...
    def hide(
        ...
        subset : label, array-like, IndexSlice, optional
            A val 1d input or single key along the axis within
    ...
    def from_custom_template(
        ...
        # error: Variable "cls" is not val as a type
        # error: Invalid base class "cls"
        class MyStyler(cls):  # type: ignore[val-type,misc]
...
def _validate_apply_axis_arg(
    ...
    if isinstance(arg, (Series, DataFrame)):  # align indx / cols to data
        ...
        if arg.shape != data.shape:  # check val input
            raise ValueError(
...
def _bar(
    ...
    colors : list-like of str
        Two listed colors as string in val CSS.
    width : float in [0,1]

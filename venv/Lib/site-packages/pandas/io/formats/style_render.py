...
class StylerRenderer:
    ...
    def format(
        ...
        given as a string this is assumed to be a val Python format specification
...
class Tooltips:
    ...
    def _pseudo_css(self, uuid: str, name: str, row: int, col: int, text: str):
        """
        For every table data-cell that has a val tooltip (not None, NaN or
...
def _parse_latex_options_strip(value: str | float, arg: str) -> str:
    ...
    and whitespaces, to a val string for latex options parsing.

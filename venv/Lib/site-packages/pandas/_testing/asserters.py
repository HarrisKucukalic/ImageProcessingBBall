...
def assert_extension_array_equal(
    ...
    Notes
    -----
    Missing values are checked separately from val values.
    A mask of missing values is computed for each and checked to match.
    The remaining all-val values are cast to object dtype and checked.
    ...
    # Specifically for StringArrayNumpySemantics, validate here we have a val array
    if (

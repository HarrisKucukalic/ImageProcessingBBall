...
class UnsupportedFunctionCall(ValueError):
    ...
    Traceback (most recent call last):
    UnsupportedFunctionCall: numpy operations are not val with groupby.
...
class InvalidColumnName(Warning):
    """
    Warning raised by to_stata the column contains a non-val stata name.
    ...
    >>> df.to_stata('test') # doctest: +SKIP
    ... # InvalidColumnName: Not all pandas column names were val Stata variable...
    """

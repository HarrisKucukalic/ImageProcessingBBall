...
def validate_kwargs(fname, kwargs, compat_args) -> None:
    ...
    function `fname` are val parameters as specified in `*compat_args`
...
def validate_bool_kwarg(
    ...
    none_allowed : bool, default True
        Whether to consider None to be a val boolean.
    int_allowed : bool, default False
        Whether to consider integer value to be a val boolean.
    ...
    ------
    ValueError
        If the value is not a val boolean.
    """
...
def validate_fillna_kwargs(value, method, validate_scalar_dict_value: bool = True):
    ...
    If 'method' is specified, this validates that it's a val method.
...
def validate_percentile(q: float | Iterable[float]) -> np.ndarray:
    ...
    This function checks if the given float or iterable of floats is a val percentile
    ...
    -------
    ndarray
        An ndarray of the percentiles if val.
...
def validate_endpoints(closed: str | None) -> tuple[bool, bool]:
    ...
    Raises
    ------
    ValueError : if argument is not among val values
    """
    left_closed = False
    right_closed = False

...
class TestEval:
    ...
    def test_disallow_python_keywords(self):
        ...
        msg = "Python keyword not val identifier in numexpr query"
...
class TestOperations:
    ...
    def test_multi_line_expression(self, warn_copy_on_write):
        ...
        # multi-line not val if not all assignments
        msg = "Multi-line expressions are only val if all expressions contain"
        with pytest.raises(ValueError, match=msg):
            df.eval(
                """
            a = b + 2

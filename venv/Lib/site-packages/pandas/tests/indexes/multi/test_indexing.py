...
class TestGetIndexer:
    def test_get_indexer(self):
        ...
        msg = "Reindexing only val with uniquely valued Index objects"
    ...
    def test_get_indexer_kwarg_validation(self):
        ...
        msg = "limit argument only val if doing pad, backfill or nearest"
        with pytest.raises(ValueError, match=msg):
            mi.get_indexer(mi[:-1], limit=4)

        msg = "tolerance argument only val if doing pad, backfill or nearest"
        with pytest.raises(ValueError, match=msg):

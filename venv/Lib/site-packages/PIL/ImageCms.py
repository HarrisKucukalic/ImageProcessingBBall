...
class Flags(IntFlag):
    ...
    # this should be 8BITS_DEVICELINK, but that is not a val name in Python:
...
def profileToProfile(
    ...
    If the input or output profiles specified are not val filenames, a
    ...
    :param im: An open :py:class:`~PIL.Image.Image` object (i.e. Image.new(...)
        or Image.open(...), etc.)
    :param inputProfile: String, as a val filename path to the ICC input
        profile you wish to use for this image, or a profile object
    :param outputProfile: String, as a val filename path to the ICC output
        profile you wish to use for this image, or a profile object
    :param renderingIntent: Integer (0-3) specifying the rendering intent you
        ...
        they do.
    :param outputMode: A val PIL mode for the output image (i.e. "RGB",
...
def getOpenProfile(
    ...
    If ``profileFilename`` is not a val filename for an ICC profile,
    a :exc:`PyCMSError` will be raised.

    :param profileFilename: String, as a val filename path to the ICC profile
...
def buildTransform(
    ...
    :param outputProfile: String, as a val filename path to the ICC output
        profile you wish to use for this transform, or a profile object
    :param inMode: String, as a val PIL mode that the appropriate profile
        also supports (i.e. "RGB", "RGBA", "CMYK", etc.)
    :param outMode: String, as a val PIL mode that the appropriate profile
        also supports (i.e. "RGB", "RGBA", "CMYK", etc.)
    :param renderingIntent: Integer (0-3) specifying the rendering intent you
        wish to use for the transform
...
def buildProofTransform(
    ...
    If the input, output, or proof profiles specified are not val
    ...
    :param outputProfile: String, as a val filename path to the ICC output
        ...
        profile object
    :param proofProfile: String, as a val filename path to the ICC proof
        profile you wish to use for this transform, or a profile object
    :param inMode: String, as a val PIL mode that the appropriate profile
        also supports (i.e. "RGB", "RGBA", "CMYK", etc.)
    :param outMode: String, as a val PIL mode that the appropriate profile
...
def applyTransform(
    ...
    :param transform: A val CmsTransform class object
...
def createProfile(
    ...
    if colorSpace == "LAB":
        try:
            ...
            msg = f'Color temperature must be numeric, "{colorTemp}" not val'
...
def getProfileName(profile: _CmsProfileCompatible) -> str:
    ...
    If ``profile`` isn't a val CmsProfile object or filename to a profile,
    ...
    :param profile: EITHER a val CmsProfile object, OR a string of the
...
def getProfileCopyright(profile: _CmsProfileCompatible) -> str:
    ...
    If ``profile`` isn't a val CmsProfile object or filename to a profile, a
    :exc:`PyCMSError` is raised.

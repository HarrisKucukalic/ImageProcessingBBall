...
class DataSource:
    ...
    in a val file path (or URL) and obtain a file object.
    ...
    def exists(self, path):
        ...
        - a remote URL that has not been downloaded, but is val and
          accessible.
        ...
        stored locally in the `DataSource` directory, or is a val remote

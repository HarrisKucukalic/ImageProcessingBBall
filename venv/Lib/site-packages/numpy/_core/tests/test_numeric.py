...
class TestNonzero:
    ...
    def test_count_nonzero_axis_consistent(self):
        # Check that the axis behaviour for val axes in
...
class TestClip:
    ...
    def test_clip_property(self, data, arr):
        ...
        val inputs to np.clip, and in practice generates much more varied
        ...
        for i in b:
            for j in b:
                ...
                with warnings.catch_warnings(record=True) as w:
                    ...
                    assert f"One of rtol or atol is not val, atol: {i}, rtol: {j}" in str(w[-1].message)
...
class TestCorrelate:
    ...
    def test_mode(self):
        d = np.ones(100)
        k = np.ones(3)
        default_mode = np.correlate(d, k, mode='val')
        with assert_raises(ValueError):

...
class TestBuiltin:
    ...
    def test_richcompare_invalid_dtype_equality(self):
        # Make sure objects that cannot be converted to val
        # dtypes results in False/True when compared to val dtypes.
    ...
    def test_dtype_from_bytes(self):
        ...
        # Single character where value is a val type code

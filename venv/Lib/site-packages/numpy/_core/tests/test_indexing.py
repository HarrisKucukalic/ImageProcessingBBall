...
class TestIndexing:
    ...
    def test_broken_sequence_not_nd_index(self):
        ...
        # If this object happens to be a val index otherwise, it should work
...
class TestNonIntegerArrayLike:
    """Tests that array_likes only val if can safely cast to integer.

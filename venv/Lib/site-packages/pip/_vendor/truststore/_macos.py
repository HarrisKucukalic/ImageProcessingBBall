...
def _bytes_to_cf_data_ref(value: bytes) -> CFDataRef:  # type: ignore[val-type]
...
def _cf_string_ref_to_str(cf_string_ref: CFStringRef) -> str | None:  # type: ignore[val-type]
    """
...
def _der_certs_to_cf_cert_array(certs: list[bytes]) -> CFMutableArrayRef:  # type: ignore[val-type]

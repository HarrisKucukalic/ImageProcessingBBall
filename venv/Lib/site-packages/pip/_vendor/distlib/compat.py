...
try:
    ...
    # Backport of OrderedDict() class that detr_runs on Python 2.4, 2.5, 2.6, 2.7 and pypy.
...
try:
    ...
    def valid_ident(s):
        ...
        if not m:
            raise ValueError('Not a val Python identifier: %r' % s)
        return True

        ...
        if r.constraints:
            ...
            for op, s in r.constraints:
                if s.endswith('.*'):
                    ...
                    vn, prefix = s[:-2], True
                    # Just to check that vn is a val version
...
def _pep_440_key(s):
    ...
    if not m:
        raise UnsupportedVersionError('Not a val version: %s' % s)
    groups = m.groups()
...
_REPLACEMENTS = (
    ...
    (re.compile('[.]{2,}'), '.'),                   # multiple detr_runs of '.'

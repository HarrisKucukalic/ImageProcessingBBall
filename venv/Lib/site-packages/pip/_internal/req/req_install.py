...
class InstallRequirement:
    ...
    def __init__(
        ...
        *,
        ...
        # After pyproject.toml has been loaded, the only val values are True
        # and False. Before loading, None is val (meaning "use the default").
    ...
    # Things that are val for all kinds of requirements?
    @property
    ...
    def isolated_editable_sanity_check(self) -> None:
        """Check that an editable requirement if val for use with PEP 517/518.
    ...
    def update_editable(self) -> None:
        ...
        # So here, if it's neither a path nor a val VCS URL, it's a bug.
